    ...
    <header className="header max-w-full relative">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-around py-2">
          {/* Logo */}
          <Link to="/">
            <img className="sm:size-20 size-12" src='https://productstorageimages.blob.core.windows.net/bannoithat-3dmodel/logo-pratise.svg' alt="Nội Thất MOHO" />
          </Link>
          ...
          <div className="flex-1 mx-8">
            <div className="flex flex-row justify-center items-center">
              ...
              <button className="transform -translate-x-10 bg-gray-800 p-2 rounded" onClick={triggerSearch}>
                <Search className="w-4 h-4 text-white" />
              </button>
              {
                userData ? (<div className='flex sm:flex-row sm:hidden gap-2'>
                  <div className='icon-user'>
                    ...
                    <div className={`dropdown-menu-user ${isOpenUser ? "open-menu-user" : ""}`}>
                      <div className='text-lg p-3 border-b-2 mx-auto'> Thông tin tài khoản </div>
                      <Link to="/information" className='p-2 hover:cursor-pointer block'>Tài khoản của bạn</Link>
                      ...
                      <svg onClick={() => setIsOpenUser((prev) => !prev)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="absolute top-2 right-2 z-30 hover:cursor-pointer size-8">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
                      </svg>
                    </div>
                  </div>
                  <Cart />
                </div>) : (<Link to="/auth" className="md:hidden  text-gray-200 hover:text-orange-500">
              ...
              userData.email ? (
                <div className="flex flex-row item gap-4 hidden sm:flex">
                  <div className='icon-user'>
                    ...
                    <div
                      className={`dropdown-menu-user relative ${isOpenUser ? "open-menu-user" : ""} z-10`}>
                ...
                <Link to="/auth" className="max-[640px]:hidden flex bg-slate-200 px-2 py-1 rounded-full items-center text-black hover:text-gray-500">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                  </svg>
                  <span>
